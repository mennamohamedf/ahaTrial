...
class Navbar extends Component{
    ...
    HomeAM(event){
        this.setState({RedirectToHomeAM:"/HODhomepage"})
    ...
    ProfileAM(event){
        this.setState({RedirectToProfile:"/ViewProfileHOD"})
        event.preventDefault()
    }
